...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> AllakroSite</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Se connecter</a> </li>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="#about" class="effect-3 scroll">A Propos de Nous</a></li>
						<li><a href="#services" class="effect-3 scroll">Services</a></li>
						<li><a href="#team" class="effect-3 scroll">Equipe</a></li>
						<li><a href="#gallery" class="effect-3 scroll">Galérie</a></li>
						<li><a href="#mail" class="effect-3 scroll">Nous contactez</a></li>
					</ul>
				</nav>
...
<div class="about-bottom">
	<div class=" w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="bLrAefyp6vM&t=4s" id="video"> <img src="images/image3.jpg" alt="" /> </div>
			<!-- <video width="560" height="315" class="img-responsive" controls>
				<source src="https://www.youtube.com/embed/E91gAjunqOM" type="video/mp4"> -->
			</video>
			
		</div>
		<div class="w3l_about_bottom_left_video">
			<h4>Regardez notre vidéo</h4>
		</div>
	</div>
	<!-- <div class="col-md-6 w3l_about_bottom_right one">
		<div class="abt-w3l">
			<div class="header-w3l">
				<h2>Formulaire pour une demande particuliaire</h2>
				<h4>Entrez les Details</h4>
				<form action="#" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							<li class="text">Votre NOM :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="name" type="text" required=""></li>
							<li class="text">Date de Naissance :  </li>
...
<div class="about-top" id="about">
	<div class="container">
		<h3 class="w3l-title">A Propos de Nous</h3>
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			...
			<div class="wthree-services-right image2">
				<img src="images/image1.jpg" alt="">
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="col-md-5 wthree-about-grids">
			<h4>Bienvenue Allakro</h4>
			<a href="#" class="trend-w3l" data-toggle="modal" data-target="#myModal"><span>Voit plus</span></a>
			<a href="#mail" class="trend-w3l scroll"><span>Nous joindre</span></a>
		</div>
		<div class="clearfix"> </div>
	</div>
</div>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='1500' data-delay='.5' data-increment="1">+1500</div>
				
				<h4 class="stats-info">Habitant</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-book" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='300' data-delay='.5' data-increment="1">+300</div>
				
				<h4 class="stats-info">Naissances</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-trophy" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='80' data-delay='.5' data-increment="10">+80</div>
				
				<h4 class="stats-info">Centres de santé</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<h4 class="stats-info">Pharmacies</h4>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
...
<section class="portfolio-w3ls" id="gallery">
		<h3 class="w3l-title">Notre galérie</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/img1.jpg" class="swipebox"><img src="images/img1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4> Etude</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Nos personnalités</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/p2.jpg" alt="">
				  <h5>Koné Tiémoman</h5>
				  <div class="about_opa">
					<p>Directeur UVCI</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/p1.jpg" alt="">
				  <h5>tidjane thiam</h5>
				  <div class="about_opa">
					<p>Directeur général du Crédit suisse</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/p3.jpg" alt="">
				  <h5>Jean Marc Yace</h5>
				  <div class="about_opa">
					<p>Maire de Cocody</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
...
<div id="mail" class="contact">
	<div class="container">
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Adresse</h4>
					<p>Abidjan, cocody</p>
					<p>2 Plateaux Chambre de Commerce</p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Téléphone</h4>
					<p>+(225) 0703785519 <span>+(225) 0584291701</span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
		...
		<div class="w3l-form">
			<h3 class="w3l-title">Nous envoyer un message</h3>
