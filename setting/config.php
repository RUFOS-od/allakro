	...
	
{
	...
	public function add_teacher($add_t_fullname,$add_t_address,$add_t_email,$add_t_username,$add_t_father,$add_t_dob,$add_t_qualification,$add_t_contact)
	{
	$add_teacher = "insert into teacher_info(t_fullname,t_address,t_email,t_username,t_father,t_dob,t_qualification,t_contact) values('$add_t_fullname','$add_t_address','$add_t_email','$add_t_username','$add_t_father','$add_t_dob','$add_t_qualification','$add_t_contact')";
	...
	public function add_student($std_fullname,$std_username,$std_password,$std_grade,$std_dob,$std_address,$std_gender,$std_father,$std_mother,$std_parent_contact)
	{
		$add_student_insert = "insert into st_info(st_fullname,st_username,st_password,st_grade,st_dob,st_address,st_gender,st_father,st_mother,st_parents_contact) value('$std_fullname','$std_username','$std_password','$std_grade','$std_dob','$std_address','$std_gender','$std_father','$std_mother','$std_parent_contact')";
		$add_student_run = $this->connectdb->query($add_student_insert);
		return $add_student_run;
	}

	public function update_student_info($std_fullname,$std_username,$std_password,$std_grade,$std_dob,$std_address,$std_gender,$std_father,$std_mother,$std_parent_contact,$student_id)
	{
		$update_student_info_select = "update st_info set st_fullname='$std_fullname',st_username='$std_username',st_password='$std_password',st_grade='$std_grade',st_dob='$std_dob',st_address='$std_address',st_gender='$std_gender',st_father='$std_father',st_mother='$std_mother',st_parents_contact='$std_parent_contact' where st_id='$student_id'";
		$update_student_info_run = $this->connectdb->query($update_student_info_select);
		return $update_student_info_run;
	}
	// Delete Student

	public function del_student($del_student)
	{
		$delete_st_info = " delete from st_info where st_id='$del_student'";
