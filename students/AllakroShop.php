...
-->
		...
		<head>
			<title>Augment an Admin Panel Category Flat Bootstrap Responsive Web Template | Projects :: w3layouts
			</title>
						...
						<div class="outter-wp">
							...
							<div class="sub-heard-part">
								<ol class="breadcrumb m-b-0">
									...
									<li class="active">AllakroShop</li>
								</ol>
							</div>
							<!--//sub-heard-part-->
							<div class="graph-visual">
								<h2 class="inner-tittle">Notre gallery </h2>
								<!--/gallery-->
								<div class="gallery">
									<div class="gallery-bottom grid">
										<div class="col-md-3 g-left">
											<a href="images/16533_booming.jpg" rel="title"
												class="b-link-stripe b-animate-go  thickbox">
												<figure class="effect-oscar">
													<img src="images/16533_booming.jpg" alt="" style="width: 700px; height:460px;" />
													<figcaption>
														<h4>bijoux</h4>
										...
										<div class="col-md-3 g-left">
											<a href="images/téléchargement (1).jpg" rel="title"
												class="b-link-stripe b-animate-go  thickbox">
												<figure class="effect-oscar">
													<img src="images/téléchargement (1).jpg" style="width: 700px; height:460px;" alt="" />
													<figcaption>
														<h4>Vêtement dame</h4>
														<p><i class="lnr lnr-magnifier"></i></p>
													</figcaption>
										...
										<div class="col-md-3 g-left">
											<a href="images/t7.jpg" rel="title"
												class="b-link-stripe b-animate-go  thickbox">
												<figure class="effect-oscar">
													<img src="images/t7.jpg" style="width: 700px; height:460px;" alt="" />
													<figcaption>
														<h4>Vêtement homme</h4>
														<p><i class="lnr lnr-magnifier"></i></p>
													</figcaption>
												</figure>
											</a>
										...
										<!--div class="col-md-3 g-left">
																		<a href="images/mosquee.jpeg" rel="title" class="b-link-stripe b-animate-go  thickbox">
																			<figure class="effect-oscar">
																				<img src="images/mosquee.jpeg" alt=""/>
																				<figcaption>
																					<h4>Religion</h4>
																						<p><i class="lnr lnr-magnifier"></i></p>
																				</figcaption>			
									...
									<!--div class="col-md-3 g-left">
																		<a href="images/school.jpeg" rel="title" class="b-link-stripe b-animate-go  thickbox">
																			<figure class="effect-oscar">
																	...
																	<div class="col-md-3 g-left">
																		<a href="images/eglise.jpeg" rel="title" class="b-link-stripe b-animate-go  thickbox">
																			<figure class="effect-oscar">
																				<img src="images/eglise.jpeg" alt=""/>
																				<figcaption>
																					<h4>Religion</h4>
																						<p><i class="lnr lnr-magnifier"></i></p>
																				</figcaption>			
																	...
																	<div class="col-md-3 g-left">
																		<a href="images/cyber.jpeg" rel="title" class="b-link-stripe b-animate-go  thickbox">
																			<figure class="effect-oscar">
																	...
																	<div class="col-md-3 g-left">
																		<a href="images/kiosque1.jpeg" rel="title" class="b-link-stripe b-animate-go  thickbox">
																			<figure class="effect-oscar">
																				<img src="images/kiosque1.jpeg" alt=""/>
																				<figcaption>
								...
								<footer>
									<p>&copy 2016 Augment . All Rights Reserved | Design by <a
							...
							<div class="sidebar-menu">
								...
								<div class="menu">
									<ul id="menu">
										...
										<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Tabs
													&amp; Panels</span> <span class="fa fa-angle-right"
													style="float: right"></span></a>
											<ul id="menu-academico-sub">
												<li id="menu-academico-avaliacoes"><a href="specialiteAllakro.html">
														Tabs &amp; Panels</a></li>
												<li id="menu-academico-boletim"><a href="widget.html">Widgets</a></li>
												<li id="menu-academico-avaliacoes"><a href="calender.html">Calender</a>
												</li>
									...
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Pages</span> <span class="fa fa-angle-right" style="float: right"></span></a>
									 ...
									 <li><a href="#"><i class="lnr lnr-envelope"></i> <span>Mail Box</span><span class="fa fa-angle-right" style="float: right"></span></a>
									   <ul>
										...
										<li id="menu-academico"><a href="#"><i class="lnr lnr-layers"></i> <span>Nos
													infos</span> <span class="fa fa-angle-right"
													style="float: right"></span></a>
											<ul id="menu-academico-sub">
										...
										<li><a href="chart.html"><i class="lnr lnr-chart-bars"></i> <span>Santé</span>
												<span class="fa fa-angle-right" style="float: right"></span></a>
											<ul>
												<li><a href="pharmacie.html"><i class="lnr lnr-map"></i> Pharmacie</a>
												</li>
												<li><a href="hopiteaux.html"><i
															class="lnr lnr-apartment"></i>Hôpitaux</a></li>
											</ul>
										</li>
										<li id="menu-comunicacao"><a href="#"><i class="fa fa-smile-o"></i>
												<span>More</span><span class="fa fa-angle-double-right"
													style="float: right"></span></a>
											<ul id="menu-comunicacao-sub">
												<li id="menu-mensagens" style="width:120px"><a
														href="project.html">Actualité <i class="fa fa-angle-right"
