...
<body>
	...
	<div class="error_page">
		...
		<div class="error-top">
			<!-- <h3 class="inner-tittle page">Utilisateur Login</h3> -->
			<div class="login">
				<h3 class="inner-tittle t-inner">Utilisateur Login</h3>
				...
				<form method="post">
					<input type="text" class="text" name="st_username" placeholder="Code CMU">
					<input type="password" placeholder="Mot de passe" name="st_password">
					<div class="submit"><input type="submit" value="Login" name="student_signin"></div>
					<div class="clearfix"></div>

					<div class="new">
						<p><label class="checkbox11"><input type="checkbox" name="checkbox"><i> </i>Forgot Password
								?</label></p>
